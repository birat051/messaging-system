...
| `DEVICE_SYNC_NOTIFY_RATE_LIMIT_WINDOW_SEC`   | no                 | `3600`                                | **`POST /v1/users/me/devices/sync-notify`** — re-broadcast **`device:sync_requested`**, per user window                                                                                                                                                                                                                                        |
| `DEVICE_SYNC_NOTIFY_RATE_LIMIT_MAX`          | no                 | `60`                                  | Max sync-notify calls per user per window                                                                                                                                                                                                                                                                                                      |
